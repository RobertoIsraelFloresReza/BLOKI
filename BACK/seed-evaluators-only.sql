-- ========================================
-- BLOCKI - Evaluators Setup (Only Evaluators)
-- ========================================
-- This script ONLY creates evaluators table and seeds data
-- Assumes properties table already exists
...
CREATE TABLE IF NOT EXISTS evaluators (
  ...
  "propertiesEvaluated" INTEGER DEFAULT 0,
...
-- ========================================
-- STEP 3: Insert Evaluator Data (4 companies)
-- ========================================
